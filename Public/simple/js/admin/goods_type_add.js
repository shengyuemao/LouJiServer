$(function() {
	...
	$("#btn_submit").click(
			function() {
				...
				$.getJSON("ajax_goods_type_add?goodtypename=" + goodtypename
						+ "&goodtypephoto=" + goodphoto, function(data) {
					if (data.code == 1) {
						alert(data.desc);
						return;
					}
					$("#center-column").load(
							"/first/Public/simple/admin_templates/goods_type_list.html?random="
									+ Math.random());
				});
